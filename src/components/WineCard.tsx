    ...
    return (
        ...
        >
            ...
            <div className="flex-grow flex flex-col justify-between relative overflow-hidden py-0.5">
                ...
                <div className="pr-8">
                    {/* Primary Title (Korean preferred, fallback to English) - Gmarket Sans */}
                    <h3 className="text-base font-['GmarketSansMedium'] text-stone-900 leading-tight mb-0.5 group-hover:text-wine-800 transition-colors truncate">
